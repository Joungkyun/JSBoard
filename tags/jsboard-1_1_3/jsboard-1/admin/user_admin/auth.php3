...
if (crypt($login[pass],$sadmin[passwd]) == $sadmin[passwd])
  header("Location: uadmin.php3?table=$table");
...
input {font: 10pt $langs[font]; BACKGROUND-COLOR:$color[bgcol]; COLOR:$color[text]; BORDER:2x solid $color[l0_bg]}
...
<form name=auth method=POST action=uadmin.php3>
$langs[ua_ment]<br>
