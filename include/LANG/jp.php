...
$langs['spamer_m'] = "SPAMMER LISTには 文内容中 入って あれば 拒否する 単語を たいてい 竝びずつ 登録します. 一応 これを 使うこと ためには jsboard/configに spam_list.txtという ファイルが 存在すると して,\nobodyに 書き取り 権限が あると します.<p>第一 終わりに ヴィン 竝びや 空白 文字が あれば だめです.";
