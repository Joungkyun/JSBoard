...
function conv_emoticon($str, $opt=0) {
  ...
  $src[] = '/([^0-9a-z])?:-?(\(|<)/';
  $con[] = "\\1<IMG SRC=./emoticon/icon4.gif BORDER=0 ALT='emoticon'>";
  $src[] = '/([^0-9a-z])?:-?(\)|>)|n\.n/';
  $con[] = "\\1<IMG SRC=./emoticon/icon5.gif BORDER=0 ALT='emoticon'>";
  $src[] = '/([^0-9])?0\.0([^0-9])?/';
  $con[] = "\\1<IMG SRC=./emoticon/icon6.gif BORDER=0 ALT='emoticon'>\\2";
  $src[] = '/([^0-9a-z])?O\.O/i';
  $con[] = "\\1<IMG SRC=./emoticon/icon6.gif BORDER=0 ALT='emoticon'>";
  $src[] = '/-\.?-V/';
  $con[] = "<IMG SRC=./emoticon/icon7.gif BORDER=0 ALT='emoticon'>";
  $src[] = '/([^0-9a-z])?(-_-|-\.-)/';
  $con[] = "\\1<IMG SRC=./emoticon/icon8.gif BORDER=0 ALT='emoticon'>";
  $src[] = '/-0-|^0^|-O-|^O^/';
  $con[] = "<IMG SRC=./emoticon/icon9.gif BORDER=0 ALT='emoticon'>";
  $src[] = '/([^0-9a-z])?:-?D/';
  $con[] = "\\1<IMG SRC=./emoticon/icon10.gif BORDER=0 ALT='emoticon'>";
  $src[] = '/([^0-9a-z])?;-?\)/';
  $con[] = "\\1<IMG SRC=./emoticon/icon11.gif BORDER=0 ALT='emoticon'>";
  $src[] = '/([^0-9a-z])?\^_\^/';
  $con[] = "\\1<IMG SRC=./emoticon/icon12.gif BORDER=0 ALT='emoticon'>";
  $src[] = '/([^0-9a-z])?:-P|:P/';
  $con[] = "\\1<IMG SRC=./emoticon/icon14.gif BORDER=0 ALT='emoticon'>";
