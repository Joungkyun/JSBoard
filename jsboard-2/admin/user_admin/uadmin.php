<?php
# $Id: uadmin.php,v 1.36 2009-11-19 05:29:50 oops Exp $
...
<TR><TD BGCOLOR=<?=$color['t_bg']?> ALIGN=center COLSPAN=6><font class=TCOLOR>Administartion Information</font></TD></TR>

<TR>
<TD width=17% BGCOLOR=<?=$color['m_bg']?>><font class=MCOLOR><?=$langs['ua_ad']?></font></TD>
<TD width=25%><?=$board['adput']?></TD>
<TD width=8% BGCOLOR=<?=$color['d_bg']?>>&nbsp;</TD>
<TD width=17% BGCOLOR=<?=$color['m_bg']?>><font class=MCOLOR>Permission</font></TD>
<TD width=25%>
<SELECT NAME=ua[mode]>
...
<TR>
<TD BGCOLOR=<?=$color['m_bg']?>><font class=MCOLOR><?=$langs['ua_pname']?></font></TD>
<TD COLSPAN=4>
<?=$langs['ua_namemt1']?>
<INPUT TYPE=radio name=ua[rnname] <?=$nameck_r?> value="1" class=RADIO><?=$langs['ua_realname']?>
<INPUT TYPE=radio name=ua[rnname] <?=$nameck_n?> value="0" class=RADIO><?=$langs['ua_nickname']?>
<?=$langs['ua_namemt2']?>
</TD>
...
<TR>
<TD BGCOLOR=<?=$color['m_bg']?>><font class=MCOLOR>Logout Page</font></TD>
<TD COLSPAN=4>
...
<TR><TD BGCOLOR=<?=$color['t_bg']?> ALIGN=center COLSPAN=6><font class=TCOLOR>Board Basic Configuration</font></TD></TR>

<TR>
<TD BGCOLOR=<?=$color['m_bg']?>><font class=MCOLOR><?=$langs['ua_b1']?></font></TD>
<TD COLSPAN=4><INPUT TYPE=text name=ua[title] size=<?=$lsize?> value="<?=$board['title']?>"></TD>
<TD BGCOLOR=<?=$color['d_bg']?>>&nbsp;</TD>
</TR>

<TR>
<TD BGCOLOR=<?=$color['m_bg']?>><font class=MCOLOR>Theme</font></TD>
<TD COLSPAN=4>
...
<TR>
<TD BGCOLOR=<?=$color['m_bg']?>><font class=MCOLOR><?=$langs['ua_align']?></font></TD>
<TD COLSPAN=4>
<INPUT TYPE=radio name=ua[align] <?=$align_c?> value="center" class=RADIO><?=$langs['ua_align_c']?>
<INPUT TYPE=radio name=ua[align] <?=$align_l?> value="left" class=RADIO><?=$langs['ua_align_l']?>
<INPUT TYPE=radio name=ua[align] <?=$align_r?> value="right" class=RADIO><?=$langs['ua_align_r']?>
</TD>
<TD BGCOLOR=<?=$color['d_bg']?>>&nbsp;</TD>
</TR>
...
<TR>
<TD BGCOLOR=<?=$color['m_bg']?>><font class=MCOLOR><?=$langs['ua_b5']?></font></TD>
<TD><INPUT TYPE=text name=ua[width] size=<?=$dsize?> value="<?=$board['width']?>"></TD>
<TD BGCOLOR=<?=$color['d_bg']?> ALIGN=center><FONT CLASS=DCOLOR><?=$langs['ua_b6']?></FONT></TD>
<TD BGCOLOR=<?=$color['m_bg']?>><font class=MCOLOR><?=$langs['ua_b7']?></font></TD>
<TD><INPUT TYPE=text name=ua[tit_l] size=<?=$dsize?> value="<?=$board['tit_l']?>"></TD>
<TD BGCOLOR=<?=$color['d_bg']?> ALIGN=center><FONT CLASS=DCOLOR><?=$langs['ua_b8']?></FONT></TD>
</TR>

<TR>
<TD BGCOLOR=<?=$color['m_bg']?>><font class=MCOLOR><?=$langs['ua_b9']?></font></TD>
<TD><INPUT TYPE=text name=ua[nam_l] size=<?=$dsize?> value="<?=$board['nam_l']?>"></TD>
<TD BGCOLOR=<?=$color['d_bg']?> ALIGN=center><FONT CLASS=DCOLOR><?=$langs['ua_b8']?></FONT></TD>
<TD BGCOLOR=<?=$color['m_bg']?>><font class=MCOLOR><?=$langs['ua_b10']?></font></TD>
<TD><INPUT TYPE=text name=ua[perno] size=<?=$dsize?> value="<?=$board['perno']?>"></TD>
<TD BGCOLOR=<?=$color['d_bg']?> ALIGN=center><FONT CLASS=DCOLOR><?=$langs['ua_b11']?></FONT></TD>
</TR>

<TR>
<TD BGCOLOR=<?=$color['m_bg']?>><font class=MCOLOR><?=$langs['ua_b12']?></font></TD>
<TD><INPUT TYPE=text name=ua[plist] size=<?=$ssize?> value="<?=$board['plist']?>">*2+1</TD>
<TD BGCOLOR=<?=$color['d_bg']?> ALIGN=center><FONT CLASS=DCOLOR><?=$langs['ua_b11']?></FONT></TD>
<TD BGCOLOR=<?=$color['m_bg']?>><font class=MCOLOR><?=$langs['ua_b13']?></font></TD>
<TD><INPUT TYPE=text name=ua[cookie] size=<?=$dsize?> value="<?=$board['cookie']?>"></TD>
<TD BGCOLOR=<?=$color['d_bg']?> ALIGN=center><FONT CLASS=DCOLOR><?=$langs['ua_b14']?></FONT></TD>
</TR>

<TR><TD COLSPAN=6><font class=BG>&nbsp;</font></TD></TR>

<TR><TD BGCOLOR=<?=$color['t_bg']?> ALIGN=center COLSPAN=6><font class=TCOLOR>Width Of Form Size</font></TD></TR>

<TR>
<TD BGCOLOR=<?=$color['m_bg']?>><font class=MCOLOR>NAME</font></TD>
<TD><INPUT TYPE=text name=ua[s_name] size=<?=$dsize?> value="<?=$size['name']?>"></TD>
<TD BGCOLOR=<?=$color['d_bg']?> ALIGN=center><FONT CLASS=DCOLOR>&nbsp;</FONT></TD>
<TD BGCOLOR=<?=$color['m_bg']?>><font class=MCOLOR>SUBMIT</font></TD>
<TD><INPUT TYPE=text name=ua[s_pass] size=<?=$dsize?> value="<?=$size['pass']?>"></TD>
<TD BGCOLOR=<?=$color['d_bg']?> ALIGN=center><FONT CLASS=DCOLOR>&nbsp;</FONT></TD>
</TR>

<TR>
<TD BGCOLOR=<?=$color['m_bg']?>><font class=MCOLOR>TITLE</font></TD>
<TD><INPUT TYPE=text name=ua[s_titl] size=<?=$dsize?> value="<?=$size['titl']?>"></TD>
<TD BGCOLOR=<?=$color['d_bg']?> ALIGN=center><FONT CLASS=DCOLOR>&nbsp;</FONT></TD>
<TD BGCOLOR=<?=$color['m_bg']?>><font class=MCOLOR>TEXT</font></TD>
<TD><INPUT TYPE=text name=ua[s_text] size=<?=$dsize?> value="<?=$size['text']?>"></TD>
<TD BGCOLOR=<?=$color['d_bg']?> ALIGN=center><FONT CLASS=DCOLOR>&nbsp;</FONT></TD>
</TR>

<TR>
<TD BGCOLOR=<?=$color['m_bg']?>><font class=MCOLOR>UPLOAD</font></TD>
<TD><INPUT TYPE=text name=ua[s_uplo] size=<?=$dsize?> value="<?=$size['uplo']?>"></TD>
<TD BGCOLOR=<?=$color['d_bg']?> ALIGN=center><FONT CLASS=DCOLOR>&nbsp;</FONT></TD>
<TD BGCOLOR=<?=$color['m_bg']?>><font class=MCOLOR>&nbsp;</font></TD>
<TD>&nbsp;</TD>
<TD BGCOLOR=<?=$color['d_bg']?> ALIGN=center><FONT CLASS=DCOLOR>&nbsp;</FONT></TD>
</TR>
...
<TR><TD BGCOLOR=<?=$color['t_bg']?> ALIGN=center COLSPAN=6><font class=TCOLOR>Print Option</font></TD></TR>

<TR>
<TD BGCOLOR=<?=$color['m_bg']?>><font class=MCOLOR><?=$langs['ua_ore']?></font></TD>
<TD COLSPAN=4>
<INPUT TYPE=radio name=ua[ore] <?=$ore_ok?> value="0" class=RADIO><?=$langs['ua_ore_y']?>
<INPUT TYPE=radio name=ua[ore] <?=$ore_no?> value="1" class=RADIO><?=$langs['ua_ore_n']?>
</TD>
<TD BGCOLOR=<?=$color['d_bg']?>>&nbsp;</TD>
</TR>

<TR>
<TD BGCOLOR=<?=$color['m_bg']?>><font class=MCOLOR><?=$langs['ua_re_list']?></font></TD>
<TD COLSPAN=4>
<INPUT TYPE=radio name=ua[re_list] <?=$re_list_ok?> value="1" class=RADIO><?=$langs['ua_re_list_y']?>
<INPUT TYPE=radio name=ua[re_list] <?=$re_list_no?> value="0" class=RADIO><?=$langs['ua_re_list_n']?>
</TD>
<TD BGCOLOR=<?=$color['d_bg']?>>&nbsp;</TD>
</TR>

<TR>
<TD BGCOLOR=<?=$color['m_bg']?>><font class=MCOLOR><?=$langs['ua_comment']?></font></TD>
<TD COLSPAN=4>
<INPUT TYPE=radio name=ua[comment] <?=$comment_ok?> value="1" class=RADIO><?=$langs['ua_comment_y']?>
<INPUT TYPE=radio name=ua[comment] <?=$comment_no?> value="0" class=RADIO><?=$langs['ua_comment_n']?>
</TD>
<TD BGCOLOR=<?=$color['d_bg']?>>&nbsp;</TD>
</TR>

<TR>
<TD BGCOLOR=<?=$color['m_bg']?>><font class=MCOLOR><?=$langs['ua_emoticon']?></font></TD>
<TD COLSPAN=4>
<INPUT TYPE=radio name=ua[emoticon] <?=$emoticon_ok?> value="1" class=RADIO><?=$langs['ua_emoticon_y']?>
<INPUT TYPE=radio name=ua[emoticon] <?=$emoticon_no?> value="0" class=RADIO><?=$langs['ua_emoticon_n']?>
</TD>
<TD BGCOLOR=<?=$color['d_bg']?>>&nbsp;</TD>
</TR>
...
<TR>
<TD BGCOLOR=<?=$color['m_bg']?>><font class=MCOLOR><?=$langs['ua_pr']?></font></TD>
<TD ALIGN=center>
<INPUT TYPE=radio name=ua[pre] <?=$pview_ok?> value="1" class=RADIO><?=$langs['ua_p']?>
<INPUT TYPE=radio name=ua[pre] <?=$pview_no?> value="0" class=RADIO><?=$langs['ua_n']?>
</TD>
<TD BGCOLOR=<?=$color['d_bg']?>>&nbsp;</TD>
<TD BGCOLOR=<?=$color['m_bg']?>><font class=MCOLOR><?=$langs['ua_pren']?></font></TD>
<TD ALIGN=center>
...
<TR><TD BGCOLOR=<?=$color['t_bg']?> ALIGN=center COLSPAN=6><font class=TCOLOR>Host Address Configuration</font></TD></TR>

<TR>
<TD BGCOLOR=<?=$color['m_bg']?>><font class=MCOLOR><?=$langs['ua_ha1']?></font></TD>
<TD COLSPAN=4> <?=$langs['ua_ha2']?> [
<INPUT TYPE=radio name=ua[dhost] <?=$dhost_ok?> value=1 class=RADIO> <?=$langs['ua_ha3']?>
<INPUT TYPE=radio name=ua[dhost] <?=$dhost_no?> value=0 class=RADIO> <?=$langs['ua_ha4']?>]
</TD>
<TD BGCOLOR=<?=$color['d_bg']?>>&nbsp;</TD>
</TR>

<TR>
<TD BGCOLOR=<?=$color['m_bg']?>><font class=MCOLOR><?=$langs['ua_ha5']?></font></TD>
<TD COLSPAN=4><?=$langs['ua_ha6']?> [
<INPUT TYPE=radio name=ua[dlook] <?=$dlook_ok?> value=1 class=RADIO> <?=$langs['ua_ha7']?>
<INPUT TYPE=radio name=ua[dlook] <?=$dlook_no?> value=0 class=RADIO> <?=$langs['ua_ha8']?>
]
</TD>
<TD BGCOLOR=<?=$color['d_bg']?>>&nbsp;</TD>
</TR>
...
<TR>
<TD BGCOLOR=<?=$color['m_bg']?>><font class=MCOLOR><?=$langs['ua_ha9']?></font></TD>
<TD COLSPAN=4><?=$langs['ua_ha10']?> [
<INPUT TYPE=radio name=ua[dwho] <?=$dwho_ok?> value=1 class=RADIO> yes
<INPUT TYPE=radio name=ua[dwho] <?=$dwho_no?> value=0 class=RADIO> no
]
</TD>
<TD BGCOLOR=<?=$color['d_bg']?>>&nbsp;</TD>
</TR>
...
<TR><TD BGCOLOR=<?=$color['t_bg']?> ALIGN=center COLSPAN=6><font class=TCOLOR>File Upload Configuration</font></TD></TR>

<TR>
<TD BGCOLOR=<?=$color['m_bg']?>><font class=MCOLOR><?=$langs['ua_fp']?></font></TD>
<TD COLSPAN=4>
<INPUT TYPE=radio<?=$upload_disable?> name=ua[upload] <?=$up_ok?> value=1 class=RADIO><?=$langs['ua_p']?>
<INPUT TYPE=radio<?=$upload_disable?> name=ua[upload] <?=$up_no?> value=0 class=RADIO><?=$langs['ua_n']?>
</TD>
<TD BGCOLOR=<?=$color['d_bg']?>>&nbsp;</TD>
</TR>

<TR>
<TD BGCOLOR=<?=$color['m_bg']?>><font class=MCOLOR><?=$langs['ua_fl']?></font></TD>
<TD COLSPAN=4>
<INPUT TYPE=radio<?=$upload_disable?> name=ua[uplink] <?=$uplink_ok?> value=1 class=RADIO><?=$langs['ua_fld']?>
<INPUT TYPE=radio<?=$upload_disable?> name=ua[uplink] <?=$uplink_no?> value=0 class=RADIO><?=$langs['ua_flh']?>
</TD>
<TD BGCOLOR=<?=$color['d_bg']?>>&nbsp;</TD>
</TR>
...
<TR><TD BGCOLOR=<?=$color['t_bg']?> ALIGN=center COLSPAN=6><font class=TCOLOR>Mail Configuration</font></TD></TR>

<TR>
<TD BGCOLOR=<?=$color['m_bg']?>><font class=MCOLOR>Admin</font></TD>
<TD ALIGN=center>
...
<TD BGCOLOR=<?=$color['d_bg']?>>&nbsp;</TD>
<TD BGCOLOR=<?=$color['m_bg']?>><font class=MCOLOR>User</font></TD>
<TD ALIGN=center>
...
<TR>
<TD BGCOLOR=<?=$color['m_bg']?>><font class=MCOLOR>E-mail</font></TD>
<TD COLSPAN=4>
...
<TR><TD BGCOLOR=<?=$color['t_bg']?> ALIGN=center COLSPAN=6><font class=TCOLOR>RSS Configuration</font></TD></TR>

<TR>
<TD BGCOLOR=<?=$color['m_bg']?>><font class=MCOLOR><?=$langs['ua_rs_u']?></font></TD>
<TD ALIGN=center>
<INPUT TYPE=radio name=ua[rss_use] <?=$rss_use_ok?> value=1 class=RADIO><?=$langs['ua_rs_ok']?>
<INPUT TYPE=radio name=ua[rss_use] <?=$rss_use_no?> value=0 class=RADIO><?=$langs['ua_rs_no']?>
</TD>
<TD BGCOLOR=<?=$color['d_bg']?>>&nbsp;</TD>
<TD BGCOLOR=<?=$color['m_bg']?>><font class=MCOLOR><?=$langs['ua_rs_de']?></font></TD>
<TD ALIGN=center>
<INPUT TYPE=radio name=ua[rs_is_des] <?=$rss_des_ok?> value=1 class=RADIO><?=$langs['ua_rs_ok']?>
<INPUT TYPE=radio name=ua[rs_is_des] <?=$rss_des_no?> value=0 class=RADIO><?=$langs['ua_rs_no']?>
</TD>
<TD BGCOLOR=<?=$color['d_bg']?>>&nbsp;</TD>
</TR>

<TR>
<TD BGCOLOR=<?=$color['m_bg']?>><font class=MCOLOR><?=$langs['ua_rs_ln']?></font></TD>
<TD ALIGN=center>
<INPUT TYPE=radio name=ua[rss_align] <?=$rss_align_no?> value=0 class=RADIO><?=$langs['ua_rs_lf']?>
<INPUT TYPE=radio name=ua[rss_align] <?=$rss_align_ok?> value=1 class=RADIO><?=$langs['ua_rs_rg']?>
</TD>
<TD BGCOLOR=<?=$color['d_bg']?>>&nbsp;</TD>
<TD BGCOLOR=<?=$color['m_bg']?>><font class=MCOLOR><?=$langs['ua_rs_co']?></font></TD>
<TD><INPUT TYPE=text name=ua[rss_color] size=<?=$dsize?> value="<?=$rss['color']?>"></TD>
<TD BGCOLOR=<?=$color['d_bg']?>>&nbsp;</TD>
</TR>

<TR>
<TD BGCOLOR=<?=$color['m_bg']?>><font class=MCOLOR><?=$langs['ua_rs_na']?></font></TD>
<TD COLSPAN=4>
...
<TR><TD BGCOLOR=<?=$color['t_bg']?> ALIGN=center COLSPAN=6><font class=TCOLOR>Etc Configuration</font></TD></TR>

<TR>
<TD BGCOLOR=<?=$color['m_bg']?>><font class=MCOLOR><?=$langs['ua_etc1']?></font></TD>
<TD ALIGN=center>
<INPUT TYPE=radio name=ua[url] <?=$url_ok?> value=1 class=RADIO>yes
<INPUT TYPE=radio name=ua[url] <?=$url_no?> value=0 class=RADIO>no
</TD>
<TD BGCOLOR=<?=$color['d_bg']?>>&nbsp;</TD>
<TD BGCOLOR=<?=$color['m_bg']?>><font class=MCOLOR><?=$langs['ua_etc2']?></font></TD>
<TD ALIGN=center>
<INPUT TYPE=radio name=ua[email] <?=$vmail_ok?> value=1 class=RADIO>yes
<INPUT TYPE=radio name=ua[email] <?=$vmail_no?> value=0 class=RADIO>no
</TD>
<TD BGCOLOR=<?=$color['d_bg']?>>&nbsp;</TD>
</TR>

<TR>
<TD BGCOLOR=<?=$color['m_bg']?>><font class=MCOLOR><?=$langs['ua_etc3']?></font></TD>
<TD><INPUT TYPE=text name=ua[d_name] size=<?=$dsize?> value="<?=$ccompare['name']?>"></TD>
<TD BGCOLOR=<?=$color['d_bg']?> ALIGN=center>&nbsp;</TD>
<TD BGCOLOR=<?=$color['m_bg']?>><font class=MCOLOR><?=$langs['ua_etc4']?></font></TD>
...
<TR><TD BGCOLOR=<?=$color['t_bg']?> ALIGN=center COLSPAN=6><font class=TCOLOR>Blocking IP Address</font></TD></TR>
...
<TR><TD BGCOLOR=<?=$color['t_bg']?> ALIGN=center COLSPAN=6><font class=TCOLOR>Deny Invalid Hyper Link</font></TD></TR>

<TR>
<TD COLSPAN=3>
<?=$langs['ua_dhyper']?>
<INPUT TYPE=radio name=ua[dhyper] <?=$dhyper_ok?> value="0" class=RADIO><?=$langs['ua_dhyper1']."\n"?>
<INPUT TYPE=radio name=ua[dhyper] <?=$dhyper_no?> value="1" class=RADIO><?=$langs['ua_dhyper2']?>
</TD>
...
<TR><TD BGCOLOR=<?=$color['t_bg']?> ALIGN=center COLSPAN=6><font class=TCOLOR>Board Notice</font></TD></TR>

<TR>
<TD BGCOLOR=<?=$color['m_bg']?>><font class=MCOLOR>Subject</font></TD>
<TD COLSPAN=4>
...
<TR>
<TD BGCOLOR=<?=$color['m_bg']?>><font class=MCOLOR>Contents</font></TD>
...
<TR><TD BGCOLOR=<?=$color['t_bg']?> ALIGN=center COLSPAN=6><font class=TCOLOR>HTML Header/Tail</font></TD></TR>
...
<TR><TD COLSPAN=6  BGCOLOR=<?=$color['m_bg']?>><font class=MCOLOR>
&lt;!-- ======================= User define stylesheet ======================= --&gt;<BR>
&lt;/STYLE&gt;<BR>
&lt;/HEAD&gt;<BR>
&lt;BODY&gt;
