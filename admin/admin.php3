...
echo "<table border=0 width=100% height=100% cellpadding=0 cellspacing=0>\n" .
     ...
     "<td rowspan=2 valign=center><font size=+2 color=$color[l0_bg]><b>OOPS&nbsp;</b></font></td>\n" .
...
if($db[name] && !$table) {
  ...
  echo "\n<tr align=center bgcolor=$color[l1_bg]>\n" .
       ...
       "<form><input type=button value=\"$langs[a_t10]\" onClick=fork('popup1','admin_info.php3')>\n" .
       "<input type=button value=\"$langs[a_t11]\" onClick=logout()>\n" .
       "</td></form>\n</tr>\n\n" .
       "<tr bgcolor=$color[l0_bg]><form name='create_db' method='post' action='act.php3'>\n" .
       ...
       "</td>\n</tr>\n\n" .
       "<tr bgcolor=$color[l0_bg]><form name='del_db' method='post' action='act.php3'>\n" .
  ...
  echo "</td><form>\n" .
       ...
       "<input type=button value=\"$langs[a_t15]\" onClick=fork('popup','admin_info.php3?mode=global')><br>\n" .
       "</td></form>\n" .
       "</tr></table>\n\n";
}
