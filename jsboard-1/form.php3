...
<TITLE>Jsboard $version - 게시판 [Form Mail]</TITLE>
<STYLE TYPE=\"text/css\">
<!--
...
<TR>
  <TD BGCOLOR=\"$color[r1_bg]\" width=13%><FONT COLOR=\"$color[r1_fg]\">To</FONT></TD>
  <TD BGCOLOR=\"$color[r2_bg]\">$sinfo[email]</TD>
</TR><TR>
  <TD BGCOLOR=\"$color[r1_bg]\"><FONT COLOR=\"$color[r1_fg]\">From</FONT></TD>
  <TD BGCOLOR=\"$color[r2_bg]\"><INPUT TYPE=\"text\" NAME=\"atc[email]\" SIZE=\"$size[name]\" MAXLENGTH=\"255\" VALUE=\"$board_cookie[email]\"></TD>
</TR><TR>
  <TD BGCOLOR=\"$color[r1_bg]\"><FONT COLOR=\"$color[r1_fg]\">$langs[name]</FONT></TD>
  ...
  <TD COLSPAN=\"2\" ALIGN=\"right\" BGCOLOR=\"$color[r1_bg]\">
    <FONT COLOR=\"$color[r1_fg]\" SIZE=\"-1\">Scripted by JoungKyun Kim</FONT>
  </TD>
</TR>
</TABLE>
