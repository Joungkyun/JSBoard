...
function count_msg() {
  ...
  $langs[count3] = "있습니다. ";
  $langs[count4] = "오늘 올라온 글은 $count[today]개입니다. ";
  $langs[count5] = "글이 없습니다.";

  return $langs;
}

$langs[ln_titl] = "JSBoard $version 관리자 페이지";
...
$langs[u_html] = "사용함";
$langs[un_html] = "사용안함";
$langs[w_ment] = "띄워쓰기 없이 쓰거나 HTML 미사용 시 한줄을 너무 길게 쓰지 마십시오.";
...
$langs[ua_pw_n] = "패스워드 없이 이 파일에 접근을 할수없습니다!!";
...
$langs[dcheck] = "apache 설정 파일이 여러개가 있습니다\n사용하시는 httpd.conf file에서 DirectoryIndex\n지시자에 index.php3가 있는지 확인해 주십시오";
...
$langs[inst_r] = "초기화";
$langs[inst_sql_err] = "<p><font color=red><b>DB 연결에 실패를 했습니다!<p>\nMySQL Root password를<br>\n확인해 주십시오\n</b></font>\n\n<br><br>\n<a href=javascript:history.back()>[ 돌아가기 ]</a><p>\n Copyleft 1999-2000 <a href=http://kldp.org/jsboard target=_blank>JSBoard Open Project</a>"; 
