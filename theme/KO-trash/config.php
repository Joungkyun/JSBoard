...
# 색상 설정
$color['nr_bg'] = '#CCD0D3';      # 공지글 배경
$color['nr_fg'] = '#000000';      # 공지글 글자
$color['l2_bg'] = '#EEF1F5';      # 보통글 배경
$color['l2_fg'] = '#000000';      # 보통글 글자
$color['l3_bg'] = '#CCD0D3';      # 답장글 배경
